...
#' @param size  (numeric) A numeric vector with the values of a second variable to be represented through the size of the circles. If NULL, all bubbles are plotted of size 1.
#' @param scale_size  (a range) Allows to set the size of the smallest and the biggest circles. If NULL, all bubbles are plotted of size 1.
...
kpBubble <- function(karyoplot, data=NULL, chr=NULL, x=NULL, y=NULL, ymin=NULL, ymax=NULL, 
